...
contract Vesting is Ownable {
    ...
    /// @notice $RECH token contract
    IERC20 public immutable RECH;
     ...
     * @param RECH_ Address of the $RECH token contract
     */
    constructor(IERC20 RECH_) Ownable() {
        RECH = RECH_;
    }
    ...
    function claim(address account) external {
        ...
        RECH.safeTransfer(account, totalAmount);
    }
    ...
    function holdTokens(HoldParams[] memory params) external onlyOwner {
        ...
        RECH.safeTransferFrom(msg.sender, address(this), totalAmount);
